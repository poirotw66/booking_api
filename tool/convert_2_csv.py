...
使用方式:
1. 轉換單一檔案: python convert_2_csv.py input.csv
2. 轉換目錄下所有 CSV: python convert_2_csv.py directory/
3. 指定輸出檔案: python convert_2_csv.py input.csv -o output.csv
4. 批次轉換並覆蓋原檔: python convert_2_csv.py directory/ --overwrite
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
使用範例:
  python convert_2_csv.py file.csv                    # 轉換單一檔案
  python convert_2_csv.py file.csv -o new_file.csv   # 指定輸出檔案
  python convert_2_csv.py ./data/                     # 轉換目錄下所有 CSV
  python convert_2_csv.py ./data/ --overwrite         # 批次轉換並覆蓋原檔
        """
    )
